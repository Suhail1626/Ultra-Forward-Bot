...
main_buttons = [[
        InlineKeyboardButton('📢 Updates', url='https://t.me/PrimeBotsUpdates'),
        InlineKeyboardButton('💬 Support', url='https://t.me/PrimeBotsSupport')
        ],[
...
async def start(client, message):
    ...
    jishubotz = await message.reply_sticker("CAACAgUAAxkBAAEDKfJl9lujVI1-lAPV8RMpG5CpA1eg4wAC4QIAAizYGVUPgqe2FsZ_hR4E")
